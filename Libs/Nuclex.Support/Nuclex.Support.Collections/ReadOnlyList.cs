...
public class ReadOnlyList<ItemType> : IList<ItemType>, ICollection<ItemType>, IEnumerable<ItemType>, IList, ICollection, IEnumerable
{
	...
	public ItemType this[int index] => typedList[index];

	/// <summary>The number of items current contained in the List</summary>
	public int Count => typedList.Count;
