...
public class PartialStream : Stream
{
	...
	public Stream CompleteStream => stream;
	...
	public PartialStream(Stream stream, long start, long length)
	{
		...
		else if (start + length > stream.Length)
		{
	...
	{
		return new NotSupportedException($"Can't {action}: the wrapped stream does not support seeking");
	}
}
