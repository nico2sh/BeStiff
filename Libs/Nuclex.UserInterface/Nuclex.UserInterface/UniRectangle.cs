...
public struct UniRectangle
{
	...
	public static readonly UniRectangle Empty = default(UniRectangle);
	...
	{
		float num = Left.Fraction * containerWidth + Left.Offset;
		float num2 = Top.Fraction * containerHeight + Top.Offset;
		return new RectangleF(num, num2, Right.Fraction * containerWidth + Right.Offset - num, Bottom.Fraction * containerHeight + Bottom.Offset - num2);
	}
