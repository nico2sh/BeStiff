...
namespace Be_Stiff
{
	internal class Crate : WorldObject, IOneSidedWorldObject
	{
		...
		public override bool LoadFromOgmo(OgmoObject obj)
		{
			...
			TheVertices.Add(new Vector2(-1f, -1f));
			TheVertices.Add(new Vector2(1f, -1f));
			TheVertices.Add(new Vector2(1f, 1f));
			TheVertices.Add(new Vector2(-1f, 1f));
			...
			GameElementsControl.LoadSprite("crate", "sprites\\objects\\crate");
			spriteCrate = GameElementsControl.GetSprite("crate");
